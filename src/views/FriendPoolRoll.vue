 ...
 * @Last Modified time: 2018-10-22 10:23:20
 */
<template>
    <div id="friend-pool">
...
import RollVillageHomePop from '../views/RollVillageHomePop.vue'
...
export default {
    ...
    computed: {
        ...
        computInviteRebat(){
            ...
            if(this.computComonRollObj && this.computComonRollObj['rows']){
                ...
                //获取过山车游戏的好友返利
                let inviteRebat1 = rollArr && rollArr[0] && rollArr[0].agent_rebate || 0;
    ...
    methods: {
        ...
        getAllFriendRecordList() {
            ...
            Promise.all([rollPromise]).then(result => {
                console.log(result);
        ...
        getWithdraw() {
            ...
            //进行提现
            that.scatterEosClient.contract(that.rollConfig.gameContract,{requiredFields}).then(hello => {
                console.log(hello);
